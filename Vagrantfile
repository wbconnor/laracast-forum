...
Vagrant.configure(2) do |config|
    ...
    config.vm.define "vebs" do |vebs|
        ...
        vebs.vm.network :forwarded_port, guest: 80,  host: 10088
        ...
        args_php_extensions = "php7.0-cli php7.0-mcrypt php7.0-fpm php7.0-mysql php7.0-mbstring php7.0-xml"
